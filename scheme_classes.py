...
class Frame:
    ...
    def make_child_frame(self, formals, vals):
        ...
        # BEGIN PROBLEM 8
        frame = Frame(self)  # Create a new Frame instance with self as the parent
        while formals is not nil:
            frame.define(formals.first, vals.first)  # Bind formal parameter to value
            formals, vals = formals.rest, vals.rest  # Move to the next pair
        return frame
        # END PROBLEM 8
